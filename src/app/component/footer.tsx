...
export default function Footer() {
  return (
    <footer className="bg-secondary w-full md:pt-[3.125rem] pt-[2rem] pb-3 flex flex-col justify-center items-center">
      ...
      <p className="mt-5 text-secondary text-base">
        © {new Date().getFullYear()} Lymanto Hadibrata. All rights reserved.
      </p>
    </footer>
  );
}
